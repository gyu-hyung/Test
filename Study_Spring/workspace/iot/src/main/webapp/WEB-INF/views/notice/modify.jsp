...
<input type="hidden" name="id" value="${vo.id}">       <!-- 수정하는경우에 잊지말고 히든속성. vo를 보내야하니까 폼을 post로하면 id 못넘기니까?-->
<table>
	<tr>
	...
	<tr>
		...
		<td class="left">
			...
			<a id="delete-file" style="display: ${ empty vo.filename ? "none" : "inline" }"><i class="fa-solid fa-ban"></i></a>
		</td>
	</tr>
</table>
